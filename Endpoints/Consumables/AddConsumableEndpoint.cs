...
public class AddConsumableEndpoint : IEndpoint
{
   public void MapEndpoint (IEndpointRouteBuilder app) =>
      app.MapPost("/{id}/add", (int id, double amount, UPXV_Context context) =>
      {
      ...
      .WithDescription("Aumenta a quantidade do Consumível com o valor passado")
